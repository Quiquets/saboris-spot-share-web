        ...
        <div className="flex flex-col md:flex-row justify-between items-start">
          <div className="mb-6 md:mb-0">
            <div className="flex items-center">
              ...
              />
              <span className="ml-2 text-xl font-bold">Saboris</span>
            </div>
          ...
          <div className="flex flex-col space-y-2">
            <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
              <DialogTrigger asChild>
                <Button 
                  variant="ghost" 
                  className="justify-start p-0 text-gray-500 hover:text-saboris-primary transition-colors"
                >
            ...
            <a 
              ...
              className="flex items-center text-gray-500 hover:text-saboris-primary transition-colors"
