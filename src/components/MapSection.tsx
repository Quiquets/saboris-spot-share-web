...
const MapSection = () => {
  ...
  useEffect(() => {
    const loadGoogleMaps = () => {
      ...
      googleMapsScript.src = `https://maps.googleapis.com/maps/api/js?key=AIzaSyBuq7aCWMYJQwiSJxN7u-DRX-2xHAeVQeo&libraries=places&v=beta`;
    ...
    const initMap = () => {
      ...
      // Use the AdvancedMarkerElement (new API) instead of deprecated Marker
